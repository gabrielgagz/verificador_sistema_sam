...
// Sumamos las posiciones impares
...
// Obtenemos el código mayor para su posterior comparación 
$codigo_menor = ($codigo_impares + $codigo_pares);
// Obtenemos el código menor. Acá utilizamos la funcion ceil() para redondeardo (FIXME)
